...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                ...
                else if($msg){?><div class="succWrap"><strong>成功</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                        <section>
...
<label for="empcode">員工編號 (不可重復)</label>
...
<div class="input-field col s12">
<button type="submit" name="update"  id="update" class="waves-effect waves-light btn indigo m-b-xs">確認更新</button>
